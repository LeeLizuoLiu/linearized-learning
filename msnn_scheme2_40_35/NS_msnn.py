...
def ResLoss_upw(x,bdry_x,f,divu_RHS,divf,bdry_velocity,beta,lamda,model_list,epoch):
    ...
    u_grad_u1_o = torch.sum(interior_u_predict_old*grad_u1_old[0], dim=1)
    u_grad_u2_o = torch.sum(interior_u_predict_old*grad_u2_old[0], dim=1)


    u_grad_u1 = (u_grad_u1_l1 + u_grad_u1_l2) - u_grad_u1_o
    u_grad_u2 = (u_grad_u2_l1 + u_grad_u2_l2) - u_grad_u2_o
